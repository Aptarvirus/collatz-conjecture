    ...
    #  above line is for taking input from a user
        if number <= 0 :
          ...
          #  enter a numm.....
           ...
           print("Enter any other number 1 :") # if the user enters 1 then the given statment will print
        else:
            while number != 1:
                if number %2 == 0:
...
#above and below line are for the collatz  conjection         
    ...
    print("U have entered wrong value plz enter a correct one") #if the given number is wrong then it will print the above statement
